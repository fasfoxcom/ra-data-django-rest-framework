          ...
          var _temp = function () {
            if (response.ok) {
              ...
              return Promise.resolve(response.json()).then(function (_response$json) {
                _setItem2.call(_localStorage2, 'token', _response$json[opts.tokenKey]);
...
function fetchJsonWithAuthToken(url, options) {
  return raCore.fetchUtils.fetchJson(url, Object.assign(createOptionsFromToken(), options));
}
...
var index = (function (apiUrl, httpClient) {
  if (httpClient === void 0) {
    httpClient = raCore.fetchUtils.fetchJson;
  }
  ...
  return {
    getList: function (resource, params) {
      try {
        ...
        var url = apiUrl + "/" + resource + "/?" + queryString.stringify(query);
...
exports.fetchJsonWithAuthToken = fetchJsonWithAuthToken;
exports.getOrderingQuery = getOrderingQuery;
exports.tokenAuthProvider = tokenAuthProvider;
//# sourceMappingURL=ra-data-django-rest-framework.cjs.development.js.map
